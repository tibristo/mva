...
if len(sys.argv) > 1:
    if sys.argv[1] == 'el':
        sig = Sample.Sample('/media/Acer/newWCalcdR/Ntuple120_newWCalcdR_trigger_sig_el12_FullCutflow.root','Ntuple','sig')
#bkg = Sample.Sample('/Disk/speyside8/lhcb/atlas/tibristo/Ntuple120_sumet_bkg12.root','Ntuple','bkg')
        bkg = Sample.Sample('/media/Acer/newWCalcdR/Ntuple120_newWCalcdR_trigger_bkg_el12.root','Ntuple','bkg')
#dataSample = Sample.Sample('/Disk/speyside8/lhcb/atlas/tibristo/Ntuple120_sumet_data12.root','Ntuple','data')
        dataSample = Sample.Sample('/media/Acer/newWCalcdR/Ntuple120_newWCalcdR_trigger_dataEl12.root','Ntuple','data')
        print 'el channel'
    elif sys.argv[1] == 'mu':
        sig = Sample.Sample('/media/Acer/newWCalcdR/Ntuple120_newWCalcdR_trigger_sig_mu12_FullCutflow.root','Ntuple','sig')
#bkg = Sample.Sample('/Disk/speyside8/lhcb/atlas/tibristo/Ntuple120_sumet_bkg12.root','Ntuple','bkg')
        bkg = Sample.Sample('/media/Acer/newWCalcdR/Ntuple120_newWCalcdR_trigger_bkg_mu12.root','Ntuple','bkg')
#dataSample = Sample.Sample('/Disk/speyside8/lhcb/atlas/tibristo/Ntuple120_sumet_data12.root','Ntuple','data')
        dataSample = Sample.Sample('/media/Acer/newWCalcdR/Ntuple120_newWCalcdR_trigger_dataMu12.root','Ntuple','data')
        print 'mu channel'
    else:
