...
void HbbTMVAClass( TString myMethodList = "" )
{
  ...
  //Syntax --> "factory->AddVariable( "VarName", "UserDefinedLabel", "units", 'VarType' );" //Where VarType refers to float, int etc.
    ...
    factory->AddVariable("dRBB","dRBB","dR(bb)",'F');
    factory->AddVariable("dEtaBB","dEtaBB","dEta(bb)",'F');
    factory->AddVariable("dPhiVBB","dPhiVBB","dPhi(V,bb)",'F');
    factory->AddVariable("dPhiLMET","dPhiLMET","dPhi(l,MET)",'F');
    factory->AddVariable("dPhiLBMin","dPhiLBMin","min dPhi(l,b)",'F');
    factory->AddVariable("pTV","pTV","pT(V)",'F');
    factory->AddVariable("mBB","mBB","mbb",'F');
    ...
    //factory->AddVariable("mLL","mLL","m(ll)",'F');//#2 lep only
    //factory->AddVariable("category","category","type of event",'I');//0, 1 or 2 lep
  ...
  if (Use["BDTG"]) factory->BookMethod( TMVA::Types::kBDT, "BDTG","!H:!V:NTrees=400:BoostType=Grad:Shrinkage=0.5:UseBaggedGrad:GradBaggingFraction=0.6:nCuts=20:NNodesMax=5");                        
  ...
  if (Use["BDTD"]) // Decorrelation + Adaptive Boost
    factory->BookMethod( TMVA::Types::kBDT, "BDTD",
			 "!H:!V:NTrees=400:nEventsMin=100:MaxDepth=4:BoostType=AdaBoost:AdaBoostBeta=0.5:SeparationType=GiniIndex:nCuts=20:PruneMethod=NoPruning:VarTransform=Decorrelate" );
  ...
  std::cout << "==> Time taken for training: " << timeTaken << std::endl;
  std::cout << "==> Time taken for testing: " << timeTakenTest << std::endl;
  delete factory;
